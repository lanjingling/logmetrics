 ...
 * used as if by calling {@code setThreadFactory(}
 * {@link Executors#defaultThreadFactory()}{@code )}.
 * 
...
public final class ThreadFactoryBuilder {
	 ...
	 *            assigned sequentially. For example, {@code "rpc-pool-%d"} will
	 *            generate thread names like {@code "rpc-pool-0"},
	 ...
	 * 
	 * @param daemon
	 *            whether or not new Threads created with this ThreadFactory
	...
	/**
	 * Sets the {@link UncaughtExceptionHandler} for new threads created with
	 * this ThreadFactory.
	 * 
	 * @param uncaughtExceptionHandler
	 *            the uncaught exception handler for new Threads created with
	 *            this ThreadFactory
	 * @return this for the builder pattern
	 */
	 ...
	 * ThreadFactory. Threads will be created by invoking #newThread(Runnable)
	 * on this backing {@link ThreadFactory}.
	 * 
	 ...
	 * building process. After building, it is still possible to change the
	 * options used to build the ThreadFactory and/or build again. State is not
	 * shared amongst built instances.
	 * 
